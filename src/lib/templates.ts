...
export const TEMPLATES: TemplateDefinition[] = [

  {
    ...
    description:
      "Site institucional completo com serviços, números e formulário de contato.",
  ...
  },
  {
    ...
    description:
      "Vitrine de produtos com destaque de ofertas, prova social e checkout externo.",
    ...
    (blueprintPage, pageIndex) => {
      ...
      pages.push({
        ...
        seo: {
          ...
          title:
            `${blueprintPage.name} · ${template.name}`,
