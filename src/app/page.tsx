...
export default async function EditorPage({
  ...
  /*
    Criação automática da estrutura inicial do site
  */
  ...
  if (content.pages.length === 0) {
    ...
    content.sections = {
      [pageId]: [
        createSection("header", 0),
        createSection("banner", 1),
        createSection("text", 2),
        createSection("cards", 3),
        createSection("form", 4),
        createSection("footer", 5),
      ],
    };
  }
